...
import io.github.llnancy.longkui.core.util.ListUtils;
...
public interface LoadBalancer {
     ...
     *
     * @param nodes   Node 列表
     * @param hashKey 哈希 key（一致性哈希算法中用于对请求进行哈希的 key）
     * @param <T>     负载均衡的对象类型
     * @return 负载均衡算法选出的 Node
     */
    ...
    /**
     * 将资源列表 sources、权重&预热时间 weightPairList 包装为 WeightNode 列表，默认权重为 1，默认预热时间为 10 分钟。
     *
     * @param sources        资源列表
     * @param weightPairList 权重&预热时间 Pair 列表
     * @param <T>            资源类型
     * @return WeightNode列表
     */
    ...
    /**
     * 将资源列表 sources、权重列表 weightList 和预热时间列表 warmupList 包装为 WeightNode 列表，默认权重为 1，默认预热时间为 10 分钟。
     *
     * @param sources    资源列表
     * @param weightList 权重列表
     * @param warmupList 预热时间列表
     * @param <T>        资源类型
     * @return WeightNode 列表
     */
    ...
    /**
     * 将资源列表 sources 和权重列表 weightList 包装为 WeightNode 列表，默认预热时间为 10 分钟。
     *
     * @param sources    资源列表
     * @param weightList 权重列表
     * @param <T>        资源类型
    ...
    /**
     * 将资源列表 sources 和预热时间列表 warmupList 包装为 WeightNode 列表，默认预热时间为 10 分钟。
     *
     * @param sources    资源列表
     * @param warmupList 预热时间列表
     * @param <T>        资源类型
    ...
    /**
     * 将资源列表 sources 包装为 WeightNode 列表，默认权重为 1，默认预热时间为 10 分钟。
     *
     * @param sources 资源列表
     * @param <T>     资源类型
     * @return WeightNode列表
